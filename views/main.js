...
console.log("Situação " + pessoa1.classificatebmi());
console.log("Situação " + pessoa2.classificatebmi());
console.log("Situação " + pessoa3.classificatebmi());
console.log("Situação " + pessoa4.classificatebmi());
console.log("Situação " + pessoa5.classificatebmi());
